...
public class CambioInteractionManager : TableInteractionManager<CambioPlayer, CambioActionData, CambioPlayerAI>
{
    ...
    private void Card_OnInteract_RevealCard(object sender, InteractEventArgs e)
    {
        ...
        Game.ExecuteAction(e.ClientID, new CambioActionData(CambioActionType.RevealCard, true, Game.CurrentPlayerTurnID.Value, 0, playerWithCardId, cardNetworkId));
    }
    ...
    private void Card_OnInteract_SwapHand(object sender, InteractEventArgs e)
    {
        ...
        Game.ExecuteAction(e.ClientID, new CambioActionData(CambioActionType.SwapHand, true, Game.CurrentPlayerTurnID.Value, 0, playerWithCardId, 0));
    }
    ...
    private void Card_OnInteract_ChooseCard(object sender, InteractEventArgs e)
    {
        ...
        Game.ExecuteAction(e.ClientID, new CambioActionData(CambioActionType.SelectCard, false, Game.CurrentPlayerTurnID.Value, 0, 0, cardNetworkId));
    }
    private void Card_OnInteract_CompareCards(object sender, InteractEventArgs e)
    {
        ulong cardNetworkId = (sender as Interactable).GetComponent<PlayingCard>().NetworkObjectId;

        Game.ExecuteAction(e.ClientID, new CambioActionData(CambioActionType.ChooseCard, true, Game.CurrentPlayerTurnID.Value, 0, 0, cardNetworkId));
